...
aws --endpoint http://localhost:4566 --profile $env:PROFILE secretsmanager update-secret --secret-id $env:SECRET --description "Exemplo de Secrets Manager" --secret-string '{\"appname\":\"product\",\"host\":\"jdbc:postgresql://localhost:5432/product\",\"user\":\"admin\",\"pass\":\"passW@rd\",\"dialect\":\"org.hibernate.dialect.PostgreSQLDialect\"}'
